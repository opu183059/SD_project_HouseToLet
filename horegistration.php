...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // duplicate check 
    $existSql = "SELECT * FROM `houseowner` WHERE firstName='$firstName'";
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `houseowner` (`firstName`, `lastName`, `email`, `transactionId`, `password`, `date`) 
...
<head>
    ...
    <title>House To-Let-House_Owner_Account_Create</title>
        ...
        <section class="wrapper">
            <div class="container">
                <div class="loginArea text-center">
                    ...
                    <form action="/HouseToLet/horegistration.php" method="post" class="rounded bg-white shadow p-5">
                        <h3 class="text-dark fw-bolder fs-4 mb-2 creatAccount">Create an Owner Account</h3>
    
                        <div class="fw-normal text-muted mb-2">
                            Already have an account? <a href="hologin.php" class="text-primary fw-bold text-decoration-none">Sign in here</a>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingLastName" name="lastName" placeholder="name@example.com">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <span class="password-info mt-2">To active your account please pay BDT <mark><span class="text-dark fw-bolder">1000tk</span></mark> in 01522558877 through Bkash & give the ID</span>
                        </div>
                        <div class="form-floating mb-3">
